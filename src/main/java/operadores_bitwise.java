...
public class operadores_bitwise{
    public static void main(String[] args) {
        ...
        System.out.printf("The first number is %d. It is represented in binary as %s.%n", value7, binary7);

        var value8 = 2;
        var binary8 = Integer.toBinaryString(value8);
        System.out.printf("The second number is %d. It is represented in binary as %s.%n", value8, binary8);

        var resultLeft = value7 >> value8;
        var binaryResultLeft = Integer.toBinaryString(resultLeft);
        System.out.printf("%d >> %d = %d. It is represented in binary as %s.%n", value7, value8, resultLeft, binaryResultLeft);
